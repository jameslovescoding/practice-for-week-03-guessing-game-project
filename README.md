...
1. when the argument is larger than secretNumber, it should print 'Too high.' and return false
2. when the argument is smaller than secretNumber, it should print 'Too low.' and return false
3. when the argument is equal to secretNumber, it should print 'Correct!' and return true
